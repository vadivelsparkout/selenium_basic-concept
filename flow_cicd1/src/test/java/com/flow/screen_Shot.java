...
public class screen_Shot {
	...
	void screen() throws IOException, InterruptedException {
		...
		// comparing screenshot and source pic
		// taking whole pic--File firstscr=((TakesScreenshot)
		// driver).getScreenshotAs(OutputType.FILE);

		WebElement taking1 = driver.findElement(By.xpath("//input[@id='twotabsearchtextbox']"));

		File target = taking1.getScreenshotAs(OutputType.FILE);

		File dest = new File("./snaps/img1.png");

		org.openqa.selenium.io.FileHandler.copy(target, dest);
